#readme: this is  the analysis proposed to be done currently
#it plots epicurve for each one and one with each
#this is also deprecated -- we are moving to scatter plots
...
import replicate_analysis_infections_impl as rai
...
#############################################################
all_replicate_models = rv.get_all_replicate_models(session, cfg_root,'_infections')
